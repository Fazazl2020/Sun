"""
networks.py - Fixed Network for Speech Enhancement
===================================================
Key fixes applied:
...
class Net(nn.Module):
    """
    Speech Enhancement Network with FAC
    ...
    def __init__(self, F=201):
        ...
        # Decoder - output_padding for F=201
        self.de5 = nn.ConvTranspose2d(512, 128, (2,3), (1,2), (1,0))
        self.de4 = nn.ConvTranspose2d(256, 64, (2,3), (1,2), (1,0), output_padding=(0,1))
