"""
networks_s1_s3.py - Network for experiments S1 and S3
=====================================================
F=161 (win=320, hop=160)

USAGE: cp networks_s1_s3.py utils/networks.py
"""
...
class AdaptiveFrequencyBandPositionalEncoding(nn.Module):
    def __init__(self, strategy='learnable-sin', F=161, sample_rate=16000):
        super().__init__()
...
class GatedPositionalEncoding(nn.Module):
    def __init__(self, in_channels, F=161, sample_rate=16000):
        super().__init__()
...
class FACLayer(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding, F=161, sample_rate=16000):
        super().__init__()
...
class Net(nn.Module):
    """Network for S1/S3: F=161"""
    def __init__(self, F=161):
        super().__init__()
        self.F = 161  # Hardcoded for S1/S3

        # Encoder
        self.conv1 = FACLayer(2, 16, (2,3), (1,2), (1,0), 161)
        self.conv2 = FACLayer(16, 32, (2,3), (1,2), (1,0), 161)
        self.conv3 = FACLayer(32, 64, (2,3), (1,2), (1,0), 161)
        self.conv4 = FACLayer(64, 128, (2,3), (1,2), (1,0), 161)
        self.conv5 = FACLayer(128, 256, (2,3), (1,2), (1,0), 161)

        # AIA Module
        self.m1 = AIA_Transformer(256, 256)

        # Decoder - F=161: no output_padding on de4
        self.de5 = nn.ConvTranspose2d(512, 128, (2,3), (1,2), (1,0))
        self.de4 = nn.ConvTranspose2d(256, 64, (2,3), (1,2), (1,0))  # No output_padding
