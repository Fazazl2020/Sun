...
==============================================
F=161, Standard Magnitude Loss

USAGE: cp configs_s1.py configs.py && python train.py
"""

import os

EXPERIMENT_NAME = 'S1-Baseline'
...
# Model Config - S1: F=161, standard mag loss
MODEL_CONFIG = {
    'in_norm': False,
    'sample_rate': 16000,
...
def print_config():
    ...
    print(f"STFT: F=161 (win=320, hop=160)")
