"""
configs_s1.py - Experiment S1: Stage1 Baseline
===============================================
InstanceNorm + MagLoss(3.0), F=161

Loss: SI-SDR + 10.0 * L1(R,I) + 3.0 * MSE(Magnitude)

USAGE:
1. Copy this file to configs.py: cp configs_s1.py configs.py
...
EXPERIMENT_NAME = 'S1-Stage1-Baseline'
EXPERIMENT_DESC = 'InstanceNorm + MagLoss(3.0), F=161'
...
CHECKPOINT_ROOT = '/ghome/fewahab/Sun-Models/Exp-S1/ckpt'


# ==================== 3. OUTPUT PATHS ====================

ESTIMATES_ROOT = '/gdata/fewahab/Sun-Models/Exp-S1/estimates'
...
MODEL_CONFIG = {
    'in_norm': False,
    'sample_rate': 16000,
    # S1: Standard STFT (F=161)
    'win_len': 0.020,       # 320 samples -> F=161
    'hop_len': 0.010,       # 160 samples
    # S1: Standard magnitude loss (no compression)
...
def print_config():
    ...
    print(f"   Compressed Mag Loss: {MODEL_CONFIG['use_compressed_mag']}")
    print(f"\nPYTORCH INFO:")
