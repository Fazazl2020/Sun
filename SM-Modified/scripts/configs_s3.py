...
========================================================
F=161, Compressed Magnitude Loss (mag^0.3)

USAGE: cp configs_s3.py configs.py && python train.py
ALSO NEED: cp criteria_s3_s4.py utils/criteria.py
"""

import os

EXPERIMENT_NAME = 'S3-CompMag'
...
# Model Config - S3: F=161, compressed mag loss
MODEL_CONFIG = {
    'in_norm': False,
    'sample_rate': 16000,
